...
using ProjetoTeste.Models.Enums;

namespace ProjetoTeste.Data
{
    public class SeedingService
    {
        private ProjetoTesteContext _context;

        public SeedingService(ProjetoTesteContext context)
        {
            _context = context;
        }
        ...
        public void Seed()
        {
            ...
            Department d4 = new Department(4, "Clothing");

            Seller s1 = new Seller(1, "Bob Brown", "bob@gmail.com", new DateTime(1998, 4, 21), 1000.0, d1);
            Seller s2 = new Seller(2, "Maria Green", "maria@gmail.com", new DateTime(1979, 12, 31), 3500.0, d2);
            Seller s3 = new Seller(3, "Travis Grey", "travis@gmail.com", new DateTime(1988, 1, 15), 2200.0, d1);
